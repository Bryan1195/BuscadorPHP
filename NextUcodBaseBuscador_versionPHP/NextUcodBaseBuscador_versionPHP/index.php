...
<!-- Lee los registros del archivo json y crea la lista de opciones para las diferentes ciudades -->
				  <?php
...
<!-- Lee los registros del archivo json y crea la lista de opciones para los tipos de viviendas -->
			  <?php
					$data=file_get_contents("data-1.json");
					$propiedades=json_decode($data,true);
...
<!-- Muestra de forma ordenada todos los registros al presionar el boton Mostrar Todos y filtra los registro segun las opciones seleccionadas -->
    <?php
